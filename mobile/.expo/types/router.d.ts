...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/login` | `/login` | `/(auth)/onboarding` | `/onboarding` | `/(auth)/register` | `/register` | `/(tabs)/chat` | `/chat` | `/(tabs)/earnings` | `/earnings` | `/(tabs)/` | `/(tabs)` | `/(tabs)/orders` | `/orders` | `/(tabs)/profile` | `/profile`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/driver-tracking/${SingleRoutePart<T>}` | `/orders/${SingleRoutePart<T>}` | `/tracking/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/driver-tracking/[orderId]` | `/orders/[id]` | `/tracking/[orderId]`;
