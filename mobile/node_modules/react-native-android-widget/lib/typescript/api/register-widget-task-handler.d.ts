...
export type WidgetTaskHandler = (props: WidgetTaskHandlerProps) => Promise<void>;
/**
 * Register a task handler that will handle widget actions
 *
 * @param handler {@link WidgetTaskHandler}
 */
export declare function registerWidgetTaskHandler(handler: WidgetTaskHandler): void;
//# sourceMappingURL=register-widget-task-handler.d.ts.map