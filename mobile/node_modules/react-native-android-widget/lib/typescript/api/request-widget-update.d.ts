 ...
 */
export declare function requestWidgetUpdate({ widgetName, renderWidget, widgetNotFound, }: RequestWidgetUpdateProps): Promise<void>;
//# sourceMappingURL=request-widget-update.d.ts.map