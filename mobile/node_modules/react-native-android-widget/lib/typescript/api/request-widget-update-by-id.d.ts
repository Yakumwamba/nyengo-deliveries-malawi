...
export interface RequestWidgetUpdateByIdProps {
     ...
     */
    renderWidget: (props: WidgetInfo) => Promise<React.JSX.Element> | React.JSX.Element;
    /**
 ...
 */
export declare function requestWidgetUpdateById({ widgetName, widgetId, renderWidget, widgetNotFound, }: RequestWidgetUpdateByIdProps): Promise<void>;
//# sourceMappingURL=request-widget-update-by-id.d.ts.map